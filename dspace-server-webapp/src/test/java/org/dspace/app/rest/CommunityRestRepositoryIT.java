...
public class CommunityRestRepositoryIT extends AbstractControllerIntegrationTest {
    ...
    @Test
    public void findEditAuthorizedCommunitiesWithQueryAndFilterQueryTest() throws Exception {
        findGenericAuthorizedCommunitiesWithQueryAndFilterQueryTest("findEditAuthorized");
    }

    @Test
    public void findAddAuthorizedCommunitiesWithQueryAndFilterQueryTest() throws Exception {
        findGenericAuthorizedCommunitiesWithQueryAndFilterQueryTest("findAddAuthorized");
    }

    @Test
    public void findReadAuthorizedCommunitiesWithQueryAndFilterQueryTest() throws Exception {
        findGenericAuthorizedCommunitiesWithQueryAndFilterQueryTest("findAdminAuthorized");
    }

    public void findGenericAuthorizedCommunitiesWithQueryAndFilterQueryTest(String method) throws Exception {
        ...
        getClient(tokenAdmin).perform(get("/api/core/communities/search/" + method)
                .param("query", "test")
                .param("filterQuery", "-search.resourceid:" + com4.getID()))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$._embedded.communities", Matchers.containsInAnyOrder(
                CommunityMatcher.matchProperties(com2.getName(), com2.getID(), com2.getHandle())
            )))
