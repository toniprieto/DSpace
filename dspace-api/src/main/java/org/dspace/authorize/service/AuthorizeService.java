...
public interface AuthorizeService {
    ...
    List<Collection> findAuthorizedByActionCollection(Context context, String query, int action, int offset, int limit)
        throws SearchServiceException, SQLException;
    ...
    long countAuthorizedByActionCollection(Context context, int action, String query)
        throws SearchServiceException, SQLException;
