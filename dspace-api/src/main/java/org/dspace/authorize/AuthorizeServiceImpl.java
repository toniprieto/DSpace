...
public class AuthorizeServiceImpl implements AuthorizeService {
    ...
    @Override
    public List<Collection> findAuthorizedByActionCollection(Context context, String query, int action, int offset,
                                                             int limit)
        throws SearchServiceException {
        List<Collection> collections = new ArrayList<>();
        if (context.getCurrentUser() == null) {
    ...
    @Override
    public long countAuthorizedByActionCollection(Context context, int action, String query)
        throws SearchServiceException {
        query = formatCustomQuery(query);
        DiscoverResult discoverResult = getDiscoverResult(context, query + "search.resourcetype:" +
                                                                   IndexableCollection.TYPE, action,
    ...
    private DiscoverResult getDiscoverResult(Context context, String query, int action, Integer offset, Integer limit,
        ...
        return searchService.searchAuthorized(context, discoverQuery, new int[]{action});
    }
