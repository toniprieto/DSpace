...
public class SubmissionConfigIT extends AbstractIntegrationTestWithDatabase {
    ...
    public void testSubmissionMapByCommunityHandleSubmissionConfig()
        ...
        Collection col3 = CollectionBuilder.createCollection(context, subcom1, "123456789/collection-test")
            ...
            .build();
        // col4 should use the item submission form mapped for the Publication entity type
        Collection col4 = CollectionBuilder.createCollection(context, subcom1, "123456789/publication-mapped")
        ...
        SubmissionConfig submissionConfig3 =
            new SubmissionConfigReader().getSubmissionConfigByCollection(col3);
        assertEquals("collectiontest", submissionConfig3.getSubmissionName());

        // for col4, it should return the item submission form defined for the entity type Publication
        SubmissionConfig submissionConfig4 =
            new SubmissionConfigReader().getSubmissionConfigByCollection(col4);
        assertEquals("publicationtest", submissionConfig4.getSubmissionName());
